                ...
                <div class="ht-right">
                    ...
                    @else
                        ...
                        @if (Auth::user()->role_id == 1)
                            <a href="/admin" class="login-panel login-panel-custom"><i class="fa fa-user"></i>Admin
                                Panel</a>
                        @endif
                        <a href="{{ route('logout') }}" class="login-panel login-panel-custom" onclick="event.preventDefault();
                                                document.getElementById('logout-form').submit();">
                            <img src="{{ secure_asset('storage/' . Auth::user()->profile_photo_path) }}" alt="" class="avatar">
                            {{ Auth::user()->name }}
                        </a>
                    @endguest
            ...
            <div class="container">
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        ...
                        <li
                            class="{{ $currentRouteName === 'shop.index' 
                            || $currentRouteName === 'shop.show'
                            || $currentRouteName === 'cart.index' ? 'active' : '' }}">
