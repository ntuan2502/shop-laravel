            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-text product-more">
                        ...
                        <a href="{{ route('shop.index', ['shop' => $currentShop->slug]) }}">{{ $currentShop->name }}</a>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <div class="product-thumbs-track ps-slider owl-carousel">
                                    <div class="pt active"
                                        data-imgbigurl="{{ asset('assets/img/product-single/product-1.jpg') }}"><img
                                            src="{{ asset('assets/img/product-single/product-1.jpg') }}" alt=""></div>
                                    <div class="pt" data-imgbigurl="{{ asset('assets/img/product-single/product-2.jpg') }}">
                ...
                @foreach ($relatedProducts as $key => $product)
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="{{ asset('assets/img/products/women-' . ($key + 1) . '.jpg') }}" alt="">
